...
const articles = [
  {
    ...
    image: "https://cdn.docslyzer.com/wp-content/uploads/Square-1200x1200-11.png",
    category: "Docslyzer Lens",
    href: "/docslyzer-lens/lens-for-browser-document-scanning",
  },
  {
    title: "AnyDocs for Lens for Browser: Document Capture for the Workflows That Break Everything Else",
    image: "https://cdn.docslyzer.com/wp-content/uploads/Blog-Hero-1920x1080-130-700x394.jpg",
    category: "Technology",
  ...
  },
  {
    ...
    image: "https://cdn.docslyzer.com/wp-content/uploads/Blog-Hero-1920x1080-11-700x394.png",
    category: "Technology",
    href: "/technology/abbyy-vs-docslyzer-idp-comparison",
  },
  {
    title: "How Yupi Powered a National WhatsApp Promotion Using Docslyzer's OCR and Antifraud Technology",
    image: "https://cdn.docslyzer.com/wp-content/uploads/Blog-Hero-1920x1080-10-700x394.png",
    category: "Technology",
  ...
  },
  {
    ...
    image: "https://cdn.docslyzer.com/wp-content/uploads/Blog-Hero-1920x1080-125-700x394.jpg",
    category: "Technology",
