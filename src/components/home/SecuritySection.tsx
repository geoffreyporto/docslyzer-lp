      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-card border border-border rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-shrink-0">
            <img
              src="https://cdn.docslyzer.com/wp-content/uploads/docslyzer-soc2-type2-compliant.png"
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mt-4">
              Docslyzer is SOC2 Type2 certified and compliant with <strong className="text-foreground">GDPR, HIPAA, CCPA and ITAR</strong> standards. Contact us for the full report.
            </p>
            <Link
              to="/security"
