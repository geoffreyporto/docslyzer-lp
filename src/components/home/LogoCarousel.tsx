...
const LogoCarousel = () => {
  return (
    <section className="py-16 border-y border-border bg-veryfi-dark/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center gap-6 mt-10 flex-wrap">
          <a href="https://www.g2.com/products/veryfi/reviews" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
          ...
          <a href="/customers" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
            <span className="font-bold text-foreground">Veryfi Customers</span>
          </a>
          <a href="https://www.capterra.com/p/180429/Veryfi/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
